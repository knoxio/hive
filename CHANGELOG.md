...
- `e2e/mh024-auto-scroll.spec.ts` — removed: badge tests require programmatic scroll to update React `isAtBottom` state in a headless environment, which is unreliable regardless of timing strategy; the auto-scroll and unseen-badge feature is covered by manual testing (tb-213)
